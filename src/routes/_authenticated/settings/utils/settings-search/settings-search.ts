...
export const SETTINGS_ITEMS: SettingsItem[] = [
	...
	{
		id: SETTING_ITEM_ID.MEMORY_GLOBAL,
		section: "memory",
		title: "Global Memory",
		description: "Memory entries applied to all agent sessions across projects",
		keywords: [
			"memory",
			"global",
			"context",
	...
	{
		id: SETTING_ITEM_ID.MEMORY_PROJECT,
		section: "memory",
		title: "Project Memory",
		description: "Memory entries specific to the current project",
		keywords: [
			"memory",
			"project",
			"context",
