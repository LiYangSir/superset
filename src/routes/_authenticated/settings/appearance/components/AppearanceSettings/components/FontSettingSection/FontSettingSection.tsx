...
} from "screens/main/components/WorkspaceView/ContentView/TabsContent/Terminal/config";
import {
	DEFAULT_CODE_EDITOR_FONT_FAMILY,
	DEFAULT_CODE_EDITOR_FONT_SIZE,
} from "screens/main/components/WorkspaceView/components/CodeEditor/constants";
