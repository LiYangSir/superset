...
import { useFileOpenMode } from "hooks/useFileOpenMode";
import { electronTrpc } from "lib/trpc-react";
import { getWorkspaceDisplayName } from "lib/getWorkspaceDisplayName";
import { electronTrpcClient as trpcClient } from "lib/trpc-client";
import { usePresets } from "react-query/presets";
import type { WorkspaceSearchParams } from "routes/_authenticated/_dashboard/utils/workspace-navigation";
import { navigateToWorkspace } from "routes/_authenticated/_dashboard/utils/workspace-navigation";
import { usePresetHotkeys } from "routes/_authenticated/_dashboard/workspace/$workspaceId/hooks/usePresetHotkeys";
import { NotFound } from "routes/not-found";
import {
	CommandPalette,
	useCommandPalette,
} from "screens/main/components/CommandPalette";
import {
	KeywordSearch,
	useKeywordSearch,
} from "screens/main/components/KeywordSearch";
import { useWorkspaceFileEventBridge } from "screens/main/components/WorkspaceView/hooks/useWorkspaceFileEvents";
import { useWorkspaceRenameReconciliation } from "screens/main/components/WorkspaceView/hooks/useWorkspaceRenameReconciliation";
import { WorkspaceInitializingView } from "screens/main/components/WorkspaceView/WorkspaceInitializingView";
import { WorkspaceLayout } from "screens/main/components/WorkspaceView/WorkspaceLayout";
import { useCreateOrOpenPR, usePRStatus } from "screens/main/hooks";
import { useAppHotkey } from "stores/hotkeys";
import { SidebarMode, useSidebarStore } from "stores/sidebar-state";
import { getPaneDimensions } from "stores/tabs/pane-refs";
import { useTabsStore } from "stores/tabs/store";
import type { Tab } from "stores/tabs/types";
import { useTabsWithPresets } from "stores/tabs/useTabsWithPresets";
import {
	findPanePath,
	getFirstPaneId,
	getNextPaneId,
...
} from "stores/tabs/utils";
import {
	useHasWorkspaceFailed,
	useIsWorkspaceInitializing,
} from "stores/workspace-init";
