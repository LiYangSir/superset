...
// TODO: implement with Tauri API — systemPreferences is Electron-only
...
function checkAccessibility(): boolean {
	// TODO: implement with Tauri API — systemPreferences.isTrustedAccessibilityClient is Electron-only
	return false;
}

function checkMicrophone(): boolean {
	// TODO: implement with Tauri API — systemPreferences.getMediaAccessStatus is Electron-only
	return false;
}
...
export const createPermissionsRouter = () => {
	return router({
		...
		requestMicrophone: publicProcedure.mutation(async () => {
			// TODO: implement with Tauri API — systemPreferences.askForMediaAccess is Electron-only
			await open(
