...
// TODO: implement trash functionality with Tauri API (e.g. trash crate or @tauri-apps/plugin-shell)
import type {
	DirectoryEntry,
...
export const workspaceFsService = createWorkspaceFsHostService({
	...
	trashItem: async (_absolutePath) => {
		// TODO: implement with Tauri API — shell.trashItem is Electron-only
		throw new Error("trashItem not yet implemented for Tauri");
	},
