...
// TODO: implement browsing data management with Tauri API — session is Electron-only
	...
	return router({
		...
		clearBrowsingData: publicProcedure
			...
			.mutation(async ({ input: _input }) => {
				// TODO: implement with Tauri API — session.clearStorageData/clearCache is Electron-only
				return { success: true };
			}),
	});
};
