...
import { HotkeyTooltipContent } from "components/HotkeyTooltipContent";
...
export function RightSidebar() {
	...
	const handleFileOpenCollapseIfNeeded = useCallback(
		(file: ChangedFile, category: ChangeCategory, commitHash?: string) => {
			if (isExpanded) {
				setMode(SidebarMode.Tabs);
			}
			handleFileOpenPane(file, category, commitHash);
		},
		[isExpanded, setMode, handleFileOpenPane],
	);

	const handleFileOpen =
		workspaceId && worktreePath ? handleFileOpenCollapseIfNeeded : undefined;
