...
export const Terminal = ({ paneId, tabId, workspaceId }: TerminalProps) => {
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: isSidebarOpen is an intentional trigger — re-fit terminal when sidebar toggles
	useEffect(() => {
