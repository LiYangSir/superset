...
import { useFileSearch } from "screens/main/components/WorkspaceView/RightSidebar/FilesView/hooks/useFileSearch/useFileSearch";
import {
	type SearchScope,
	useSearchDialogStore,
} from "stores/search-dialog-state";
