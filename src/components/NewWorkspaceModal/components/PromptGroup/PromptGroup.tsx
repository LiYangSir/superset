...
import { resolveEffectiveWorkspaceBaseBranch } from "lib/workspaceBaseBranch";
import {
	useCreateWorkspace,
	useHandleOpenedWorktree,
	useOpenExternalWorktree,
} from "react-query/workspaces";
import { navigateToWorkspace } from "routes/_authenticated/_dashboard/utils/workspace-navigation";
import { ProjectThumbnail } from "screens/main/components/WorkspaceSidebar/ProjectSection/ProjectThumbnail";
