...
pub async fn trpc_call(
    ...
    match path.as_str() {
        ...
        "external.openInApp" => return external::open_in_app(input),
        ...
        "filesystem.searchFiles" => return filesystem::search_files(input),
        "filesystem.searchFilesMulti" => return filesystem::search_files_multi(input),
        "filesystem.searchKeyword" => return filesystem::search_keyword(input),
